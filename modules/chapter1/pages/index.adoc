...
A RHEL9 server is running Red Hat Satellite 6.17 but hammer ping command shows candlepin failure. This failure needs to be fixed for successfully running candlepin service on satellite.
